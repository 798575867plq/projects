...
namespace WeiBo.dal.dao
{
    public class TblReturnDAO
    {
        ...
        {
            return DBHelper.QueryList(new TblReturn(), @"select r.content,r.created,u.nickname
                from TblReturn r
        ...
        {
            return DBHelper.Update(@"insert into TblReturn(mid,uid,content) values(@p0,@p1,@p2)"
                , r.Mid, r.Uid, r.Content);
        }
    }
}